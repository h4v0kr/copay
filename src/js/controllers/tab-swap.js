...
angular.module('copayApp.controllers').controller('tabSwapController', function($rootScope, $scope, $timeout, $log, $ionicModal, $state, $ionicHistory, $ionicPopover, storageService, platformInfo, walletService, profileService, configService, lodash, gettextCatalog, popupService, bwcError, bitcoreCash) {
  ...
  $scope.shouldShowSwapAddressFromHardware = function() {
  ...
  $scope.showSwapAddressFromHardware = function() {
    var wallet = $scope.wallet;
    if (wallet.isPrivKeyExternal() && wallet.credentials.hwInfo) {
      walletService.showSwapAddressFromHardware(wallet, $scope.addr, function() {});
    }
  };
